...
2, 3(???)	error.log	Реєстрація помилок роботи сервера та системних збоїв.

4	access.log (HTTP logs).

5, 6	Слухають порт 80 (IPv4 та IPv6).

7-10	Керування робочими процесами (передача команд від Master до Workers).
